...
void bluetoothMenuLoop() {
	MENU bluetoothMenu[] = {
		...
		{PID::BAD_BLE,      L->MENU_BT_BAD_BLE, Icons::duck},
		{PID::BT_KEYBOARD,  L->MENU_BT_KEYBOARD, Icons::keyboard},
		{PID::BT_MOUSE,     L->MENU_BT_AIR_MOUSE, Icons::mouse},
		{PID::BT_MOUSE_JIGGLER, L->MENU_BT_MOUSE_JIGGLER, Icons::mouse},
		{PID::BT_PRESENTER, L->MENU_BT_PRESENTER},
		{PID::BT_SHUTTER,   L->MENU_BT_SHUTTER, Icons::camera},
	};
